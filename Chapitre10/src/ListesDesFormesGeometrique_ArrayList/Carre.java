...
public class Carre extends Formes{
	...
	// le constructeur par defaut
	 ...
	 // surcharge du constructeur
		public Carre(int xx0, int yy0, int xx1, int yy1, int xx2, int yy2, int xx3, int yy3, int ll, int hh, int cc) {
			super(xx0, yy0, cc);
			XPoints[0] = CoordonneX;
			YPoints[0] = CoordonneY;
	...
	// la methode deplacer le triangle
		public void deplacer(int nx, int ny) {
			...
			for(int i = 0; i < XPoints.length; i++) {
				...
				YPoints[i] = verifier(ny, 0, getLargeurEcran());
			}
		}
		
	// la methode afficher le Carre 
		public void afficher() {
			System.out.println("\n------------- Carre ----------------");
			super.afficher();
			System.out.println("Cottes(C) = "+largeur);
		}
		
	// la methode obtenire information
		public String getInfo() {
			String tmp = super.getInfo();
			return "Carre; "+tmp+"; "+XPoints[1]+"; "+YPoints[1]+"; "+XPoints[2]+"; "+YPoints[2]+XPoints[3]+"; "+YPoints[3];
		}
}
