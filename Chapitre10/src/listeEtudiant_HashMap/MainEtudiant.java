...
public class MainEtudiant {
	...
	public static void main(String[] args) {
		byte choix = 0;
		char car;
		String NomEtud , prenomEtud, ClasseEt;
		int semestreEt;
				...
				case 2 :
					do {
						...
						if(car == 'c' || car == 'C') {
							...
							ClasseEt = clavier.next();
							System.out.print("Entrez le semestre inscrit : ");
							semestreEt = clavier.nextInt();
							...
							do 
							{
								...
								if(car == 'o' || car == 'O') {
								  c.ModifierEntier(NomEtud, prenomEtud);
									 ...
									 c.ModifierNotes(NomEtud, prenomEtud, ClasseEt, semestreEt);
								}else {
