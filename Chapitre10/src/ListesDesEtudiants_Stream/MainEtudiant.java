	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (choix) {
				...
				case 5 :
					prenomEtud = " ";
				     System.out.println("Nom de l'etudiant recherche : ");
				     prenomEtud = clavier.next();
				     c.memeprenom(prenomEtud);
				break;
				case 6 :
					matriculEtud = " ";
					NomEtud = " ";
...
public static byte menuPrincipale() {
	...
	System.out.println("3. recherche d'un etudiant par sa matricule");
	System.out.println("4. Recherche le major de la promotion");
	System.out.println("5. Rechercher un étudiant pas son prénom ");
	System.out.println("6. Suprimer un etudiant");
	System.out.println("7. Affiche la liste des etudiants");
