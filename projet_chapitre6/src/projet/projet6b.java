...
public class projet6b {
			    ...
			    switch(choix) {
			       ...
			       case 2:
			    	   ...
			    	   if(numeroLu == numeroCpte) {
			    		   affichercpt(numeroCpte, typecpt, taux, val_courant);
			    	   }else {
	...
	public static byte menu() {
	  ...
	  public static void affichercpt(long num, char type, double taux, double val) {
		  System.out.println("Le compte n° : "+num+"est un compte ");
		   if(type == 'C' ) {
