...
public class projet6c {
			    ...
			    switch(choix) {
			       ...
			       case 2:
			    	   ...
			    	   if(numeroLu == numeroCpte) {
			    		  // il n'affichera rien que si on sourchage la methode affichercpt voir l'exercice projet6b
			    		   affichercpt();
			    	   }else {
	...
	public static byte menu() {
	  ...
	  public static void affichercpt() {
		  long numeroLu = 0;
		  char typeCpt = '\0';
		  double taux = 0.0;
		  double val_courant = 0.0;
		  System.out.println("Le compte n° : "+numeroLu+" est un compte ");
		   if(typeCpt == 'C' ) {
